...
#' 
#' # To change the scale for the half-Cauchy prior on sigma, the standard error
#' # of the regression, we can use rstanarm_family():
...
#' }
#'
stan_glm <- function(formula, family = gaussian(), 
                     data, weights, subset,
