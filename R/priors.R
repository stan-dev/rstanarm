...
#'   additionally modified internally by \pkg{rstanarm} as follows: for a
...
#'   scale(s) by \code{2*sd(x)}; if the \emph{response} is Gaussian, the prior
#'   scales are also multiplied by \code{2*sd(y)}.
#'   
