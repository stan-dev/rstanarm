...
#' @import bayesplot
#' @import rstantools
#' @export log_lik posterior_linpred posterior_predict posterior_interval predictive_interval predictive_error prior_summary loo_linpred loo_predict loo_pit loo_predictive_interval
#' @export loo waic
