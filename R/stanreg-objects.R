...
#'   listed below. Each stanreg object will also have additional
#'   components and at least one additional class depending on the model. The
#'   additional class(es) can be 'lm', 'glm', 'polr', 'lmerMod', or 'aov'.
#'   
