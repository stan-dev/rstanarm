...
#' @param newdataLong Data frame containing the longitudinal data
#' @param newdataEvent Data frame containing the event data
#' @param lossfn A character string specifying the loss function to use.
#'
