...
#' @param npoints The number of time points at which to predict the survival 
#'   function. The plot of the survival function is generated by interpolating
#'   these points using \code{\link[ggplot2]{geom_line}}.
