...
pars_to_monitor <- function(standata, is_jm = FALSE) {
  c(if (standata$M > 0 && standata$intercept_type[1]) "yAlpha1", 
    ...
    if (standata$M > 4 && standata$intercept_type[5]) "yAlpha5",
    if (standata$M > 5 && standata$intercept_type[6]) "yAlpha6",
    if (standata$M > 6 && standata$intercept_type[7]) "yAlpha7",
    if (standata$M > 7 && standata$intercept_type[8]) "yAlpha8",
    if (standata$M > 8 && standata$intercept_type[9]) "yAlpha9",
    if (standata$M > 9 && standata$intercept_type[10]) "yAlpha10",
    if (standata$M > 10 && standata$intercept_type[11]) "yAlpha11",
    if (standata$M > 11 && standata$intercept_type[12]) "yAlpha12",
    if (standata$M > 12 && standata$intercept_type[13]) "yAlpha13",
    if (standata$M > 13 && standata$intercept_type[14]) "yAlpha14",
    if (standata$M > 14 && standata$intercept_type[15]) "yAlpha15",
    if (standata$M > 15 && standata$intercept_type[16]) "yAlpha16",
    if (standata$M > 16 && standata$intercept_type[17]) "yAlpha17",
    if (standata$M > 17 && standata$intercept_type[18]) "yAlpha18",
    if (standata$M > 18 && standata$intercept_type[19]) "yAlpha19",
    if (standata$M > 19 && standata$intercept_type[20]) "yAlpha20",
    if (standata$M > 0 && standata$yK[1]) "yBeta1",
    if (standata$M > 1 && standata$yK[2]) "yBeta2",
    if (standata$M > 2 && standata$yK[3]) "yBeta3",
    if (standata$M > 3 && standata$yK[4]) "yBeta4",
    if (standata$M > 4 && standata$yK[5]) "yBeta5",
    if (standata$M > 5 && standata$yK[6]) "yBeta6",
    if (standata$M > 6 && standata$yK[7]) "yBeta7",
    if (standata$M > 7 && standata$yK[8]) "yBeta8",
    if (standata$M > 8 && standata$yK[9]) "yBeta9",
    if (standata$M > 9 && standata$yK[10]) "yBeta10",
    if (standata$M > 10 && standata$yK[11]) "yBeta11",
    if (standata$M > 11 && standata$yK[12]) "yBeta12",
    if (standata$M > 12 && standata$yK[13]) "yBeta13",
    if (standata$M > 13 && standata$yK[14]) "yBeta14",
    if (standata$M > 14 && standata$yK[15]) "yBeta15",
    if (standata$M > 15 && standata$yK[16]) "yBeta16",
    if (standata$M > 16 && standata$yK[17]) "yBeta17",
    if (standata$M > 17 && standata$yK[18]) "yBeta18",
    if (standata$M > 18 && standata$yK[19]) "yBeta19",
    if (standata$M > 19 && standata$yK[20]) "yBeta20",
    if (is_jm) "e_alpha",
    ...
    if (standata$M > 3 && standata$has_aux[4]) "yAux4",
    if (standata$M > 4 && standata$has_aux[5]) "yAux5",
    if (standata$M > 5 && standata$has_aux[6]) "yAux6",
    if (standata$M > 6 && standata$has_aux[7]) "yAux7",
    if (standata$M > 7 && standata$has_aux[8]) "yAux8",
    if (standata$M > 8 && standata$has_aux[9]) "yAux9",
    if (standata$M > 9 && standata$has_aux[10]) "yAux10",
    if (standata$M > 10 && standata$has_aux[11]) "yAux11",
    if (standata$M > 11 && standata$has_aux[12]) "yAux12",
    if (standata$M > 12 && standata$has_aux[13]) "yAux13",
    if (standata$M > 13 && standata$has_aux[14]) "yAux14",
    if (standata$M > 14 && standata$has_aux[15]) "yAux15",
    if (standata$M > 15 && standata$has_aux[16]) "yAux16",
    if (standata$M > 16 && standata$has_aux[17]) "yAux17",
    if (standata$M > 17 && standata$has_aux[18]) "yAux18",
    if (standata$M > 18 && standata$has_aux[19]) "yAux19",
    if (standata$M > 19 && standata$has_aux[20]) "yAux20",
