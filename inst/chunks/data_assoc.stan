  ...
  //---- data for calculating eta in GK quadrature
    ...
    matrix[nrow_y_Xq[1]*(assoc_uses[1,1] == 1),yK[1]] y1_xq_eta; 
    matrix[nrow_y_Xq[2]*(assoc_uses[1,2] == 1),yK[2]] y2_xq_eta; 
    matrix[nrow_y_Xq[3]*(assoc_uses[1,3] == 1),yK[3]] y3_xq_eta; 
  ...
  //---- data for calculating derivative of eta in GK quadrature
    ...
    // fe design matrix at quadpoints
    matrix[nrow_y_Xq[1]*(assoc_uses[2,1] == 1),yK[1]] y1_xq_eps; 
    matrix[nrow_y_Xq[2]*(assoc_uses[2,2] == 1),yK[2]] y2_xq_eps; 
    matrix[nrow_y_Xq[3]*(assoc_uses[2,3] == 1),yK[3]] y3_xq_eps; 
  ...
  //---- data for calculating integral of eta in GK quadrature
	  ...
	  vector[nrow_y_Xq_auc*(sum(assoc_uses[3,])>0)] auc_qwts;
		
    // fe design matrix at quadpoints
    matrix[nrow_y_Xq_auc*(assoc_uses[3,1] == 1),yK[1]] y1_xq_auc; 
    matrix[nrow_y_Xq_auc*(assoc_uses[3,2] == 1),yK[2]] y2_xq_auc; 
    matrix[nrow_y_Xq_auc*(assoc_uses[3,3] == 1),yK[3]] y3_xq_auc; 
