...
#'   values for various family-specific parameters. Also, in addition to all of 
#'   the traditionally available \code{\link[=family]{families}},
#'   \pkg{rstanarm} supports families \code{\link{neg_binomial_2}} for
#'   negative binomial models and \code{\link{t_family}} for linear models with
