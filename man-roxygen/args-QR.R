...
#'   especially correlated predictors. See the \link{QR-argument} documentation 
#'   page for details on how \pkg{rstanarm} does the transformation and
#'   important information about how to interpret the prior distributions of the
#'   model parameters when using \code{QR=TRUE}.
