...
#'   idea. (\strong{Note:} if the \code{scaled} argument to 
#'   \code{\link{prior_options}} is left at its default and recommended value of
#'   \code{TRUE}, then the scale(s) of \code{prior} may be modified internally
#'   based on the scales of the predictors, as in the \pkg{arm} package. See
#'   \code{\link{priors}} for details.)
