...
#> List of 2
#>  $ value   : num [1:56] 0.4426 0.1175 0.0708 0.1032 0.1665 ...
#>  $ pareto_k: num [1:56] 0.916 0.389 0.568 0.469 0.669 ...
#> List of 2
#>  $ value   : num [1:56] 4.27 1.547 0.581 0.518 5.633 ...
#>  $ pareto_k: num [1:56] 0.857 0.389 0.629 0.409 0.692 ...
#> List of 2
#>  $ value   : num [1:56, 1:2] 3 0 0 0 1 0 0 2 0 0 ...
#>   ..- attr(*, "dimnames")=List of 2
#>   .. ..$ : NULL
#>   .. ..$ : chr [1:2] "10%" "90%"
#>  $ pareto_k: num [1:56] 0.857 0.389 0.568 0.409 0.64 ...
```
