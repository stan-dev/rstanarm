...
describes how much of the prediction intervals in each of the two groups overlap
as a proportion. For example, suppose there is a $15\%$ overlap between the
$90\%$ prediction intervals in each of the two groups. This allows us to say,
given that we are $90\%$ certain about where the predictions lie, there's a
$15\%$ chance that the two groups are similar.
