---
title: "Estimating Generalized Linear Models for Binary and Binomial Data with the rstanarm Package"
...
%\VignetteIndexEntry{GLMs for Binary and Binomial Data}
-->
...
```
```{r, ARSENIC-plot-model2, dev="png", fig.ext=".png"}
