...
available functions for specifying priors (e.g., `prior = normal(0, 1)`). The
...
[_How the Shape of a Weakly Informative Prior Affects  Inferences_](http://mc-stan.org/documentation/case-studies/weakly_informative_shapes.html).
