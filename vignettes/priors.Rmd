...
deviation, has a default prior that is $\mathsf{half-Cauchy}(0, 5)$. However, in
...
The __Scale Adjustments__ section below goes into more detail about how this
...
* If the __outcome__ $y$ is Gaussian, the prior scales for the intercept, 
