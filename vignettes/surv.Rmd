...
We will again simulate some survival data using the **simsurv** package (Brilleman, 2018) to show how a piecewise constant hazard ratio can be estimated using `stan_surv`.
...
We know estimate a model with a piecewise constant time-varying effect for the covariate `trt` as

```{r tve_fit2, warning = FALSE, message = FALSE, results='hide'}
