...
%\VignetteIndexEntry{GLMs for Continuous Data}
-->
...
loo1 <- loo(post1, cores = CORES)
loo2 <- loo(post2, cores = CORES)
loo3 <- loo(post3, cores = CORES)
loo4 <- loo(post4, cores = CORES)
...
```{r, KIDIQ-plot-predict, fig.width=9}
