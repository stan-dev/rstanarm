...
There are in fact a whole range of possible association structures, many of which have been discussed in the literature [14-16]. The `stan_jm` modelling function allows for the following association structures:
...
mod3 <- stan_jm(
    ...
    time_var = "year",
    chains = 1, iter = 2000, seed = 12345, refresh = 20)
```
