...
predictor to construct each $\beta_k = \lambda_k \sigma_y / \sigma_{x_k}$.
...
$\sigma_{y^\ast} = 1 / \sqrt{1 - R^2}$ is an intermediate parameter.
...
$\omega = \sigma_y / \widehat{\sigma_y}$ parameter to estimate.
...
and only conveys the reasonable prior information that no category has
