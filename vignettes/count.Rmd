...
%\VignetteIndexEntry{Estimating Generalized Linear Models for Count Data with the rstanarm Package}
-->
...
```{r, ROACHES-loo}
library(loo)
loo1 <- loo(stan_glm1, cores = CORES)
loo2 <- loo(stan_glm2, cores = CORES)
compare(loo1, loo2)
```
