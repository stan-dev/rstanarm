...
We've also specified some optional arguments. The `chains` argument governs
how mang Markov chains are execture, the `cores` argument controls the
...
as other topics related to GLM estimation 
(`?stan_glm`, `help(stan_glm, package = 'rstanarm')`).
...
```{r, ROACHES-negbin-ppcheck, fig.width=9}
library(gridExtra)
