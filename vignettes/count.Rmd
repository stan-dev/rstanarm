...
%\VignetteIndexEntry{GLMs for Count Data}
-->
...
```{r, ROACHES-plot-ppcheck1, fig.height=3, fig.width=4}
...
```{r, ROACHES-plot-ppcheck2, fig.height=3, fig.width=8}
library(gridExtra)
