...
in the original data. We can do this easily using the `pp_check` function, which
generates graphical comparisons of the data `y` and replicated datasets `yrep`.

```{r, ROACHES-plot-pp_check1, fig.height=3, fig.width=4}
...
```{r, ROACHES-plot-pp_check2, fig.height=3, fig.width=8}
library(gridExtra)
