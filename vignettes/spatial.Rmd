...
We can also compare the model's predictive performance using the [loo](http://mc-stan.org/loo) package. 

```{r loo-besag, results='hide'}
library(loo)
...
The difference between these two models is negative indicating the correct model has higher predictive accuracy.
