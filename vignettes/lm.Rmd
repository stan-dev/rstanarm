...
parameters than the model estimated by `stan_lm`. However, the fit to the
data is worse with `stan_lmList` in this case so there is no reason to 
prefer it over `stan_lm`.
